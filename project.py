...
lable_2.place(x=55,y=220)

lable_3 = Label(root,text="Pressure : ",width = 20,bg='white',font=("bold",10),fg='blue')
lable_3.place(x=55,y=240)

lable_5 = Label(root,text="Description : ",width = 20,bg='white',font=("bold",10),fg='blue')
lable_5.place(x=55,y=260)

lable_temp = Label(root,text="...",width = 9,bg='white',font=("bold",10),fg='blue')
lable_temp.place(x=185,y=220)

lable_pres = Label(root,text="...",width = 9,bg='white',font=("bold",10),fg='blue')
lable_pres.place(x=185,y=240)

lable_desc = Label(root,text="...",width = 9,bg='white',font=("bold",10),fg='blue')
lable_desc.place(x=185,y=260)
...
def getTemp():
    ...
    api_key = "5fa70590378b2cf06fca2de89f8c616f"
